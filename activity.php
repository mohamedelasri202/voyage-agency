...
<div class="max-w-md mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden relative bottom-[110vh] hidden " id="active" >
    <div class="text-2xl h-10 px-6 bg-gray-900 text-white text-center font-bold ">
       <h4>Add activity</h4>
    </div>
    <form class="py-2 px-6" action="" method="POST">
        <div class="mb-2">
        ...
        <div class="mb-4">
            ...
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="description" type="text" placeholder="Enter your name"  name="description">
        </div>
      
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="destination">
            destination
            </label>
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="destination" type="text" placeholder="Enter your email" name="destination">
        </div>
        <div class="mb-4">
            ...
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="phone" type="tel" placeholder="Enter your phone number" name="price">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="final_date" type="date" placeholder="Select a date" name="start_date">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="final_date">
            final_date
            </label>
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="places" type="date" placeholder="Select a date" name="final_date">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="places">
          places
            </label>
            <input
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="places" type="number" placeholder="Select a date" name="places">
        </div>
